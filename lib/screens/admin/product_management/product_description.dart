...
class ProductDescription extends StatelessWidget {
  final ProductDescriptionController controller = Get.put(ProductDescriptionController());
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              SizedBox(height: 8),
              Obx(() => Row(
                children: controller.ramOptions.map((ram) {
                  return Padding(
                    padding: const EdgeInsets.symmetric(horizontal: 4.0),
                    child: ChoiceChip(
                      label: Text(ram),
                      selected: controller.selectedRam.value == ram,
                      onSelected: (_) => controller.selectRam(ram),
                    ),
                  );
                }).toList(),
              )),
